...
try:
    ...
    try:
        ...
        from anthropic.types.beta.beta_web_search_tool_20250305_param import (  # pyright: ignore[reportMissingImports]
            UserLocation as BetaUserLocationParam,  # type: ignore[assignment]
        )
